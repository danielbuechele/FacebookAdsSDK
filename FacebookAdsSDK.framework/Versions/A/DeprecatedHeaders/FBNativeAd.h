...
@property (nonatomic, weak) NSObject<FBNativeAdDelegate>* delegate;
...
- (void)handleClickWithRootViewController:(UIViewController *)rootViewController
...
/* Call isAdLoaded to check whether native ad is loaded & internal consistent prior rendering using its properties. If
